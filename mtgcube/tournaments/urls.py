...
urlpatterns = [
    ...
    path("event-dashboard/draft/check-in/", player_data_views.CheckinView.as_view(), name="checkin"),
    path("event-dashboard/draft/check-out/", player_data_views.CheckoutView.as_view(), name="checkout"),
    ...
    path("event-dashboard/draft/my-pool-check-in/<int:image_id>/~delete/", player_data_views.DeleteImageCheckinView.as_view(), name="delete_image_checkin"),
    path("event-dashboard/draft/my-pool-check-out/<int:image_id>/~delete/", player_data_views.DeleteImageCheckoutView.as_view(), name="delete_image_checkout"),
    ...
    path("~announcement/", player_data_views.AnnouncementView.as_view(), name="announcement"),
    path("~next-draft/", player_data_views.UpcomingDraftView.as_view(), name="next_draft"),
    path("~standings/", player_data_views.PlayerEventStandingsView.as_view(), name="event_standings"),
