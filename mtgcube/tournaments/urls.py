...
urlpatterns = [
    ...
    path("event-dashboard/<slug:slug>/~player-basic-info/", player.PlayerBasicInfoView.as_view(), name="player_basic_info"),
    ...
    path("event-dashboard/<slug:slug>/draft/~player-match-info/", player.PlayerMatchInfoView.as_view(), name="player_match_info"),
    ...
    path("event-dashboard/<slug:slug>/draft/<int:draft_id>/~report-result/", player.ReportResultView.as_view(), name="report_result"),
    path("event-dashboard/<slug:slug>/draft/<int:draft_id>/~confirm-result/", player.ConfirmResultView.as_view(), name="confirm_result"),
