...
urlpatterns = [
    ...
    path("event-dashboard/<slug:slug>/my-current-draft/checkin-deck-upload/", templates.MyPoolCheckinView.as_view(), name="my_pool_checkin"),
    path("event-dashboard/<slug:slug>/my-current-draft/checkout-deck-upload/", templates.MyPoolCheckoutView.as_view(), name="my_pool_checkout"),
